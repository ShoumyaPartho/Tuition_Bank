...
public class tuition_lists extends AppCompatActivity {
    ...
    String gotLoc1,gotClass1,gotSub1;
    TextView tvSearch;
    String mail;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gotLoc1= bundle.getString("loc");
        gotClass1=bundle.getString("class");
        gotSub1=bundle.getString("sub");
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                for(DataSnapshot tuitionSnapshot : dataSnapshot.getChildren()){
                    ...
                    if(tuitionInformation.getLocation1().equals(gotLoc1) &&
                            tuitionInformation.getClass1().equals(gotClass1) &&
                            tuitionInformation.getSubject1().equals(gotSub1)
                    )
